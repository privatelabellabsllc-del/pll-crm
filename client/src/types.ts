...
export type MainView = 'dashboard' | 'customers' | 'sales_pipeline' | 'production' | 'inventory' | 'suppliers' | 'purchase_orders' | 'formulas' | 'production_planning' | 'reports' | 'profit_analytics' | 'compliance' | 'backup';
